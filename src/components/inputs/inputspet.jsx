    ...
    return (
        <div>
            <div className="mb-3">
                ...
                <input type="text" onChange={onInputChange} className="form-control" id="kind" value={pet.kind} placeholder="Например: Кошка"
                       required/>
            ...
            <div className="mb-3">
                ...
                <input onChange={onInputChange} type="text" className="form-control" id="district" required placeholder="Например: Приморский"
                       value={pet.district}/>
                <div className="form-text">Обязательное поле.</div>
            </div>
